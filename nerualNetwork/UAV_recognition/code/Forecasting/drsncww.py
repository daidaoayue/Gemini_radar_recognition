...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        #use 0*0 convolution to match the dimension
...
class RSNet(nn.Module):
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride):
        ...
        # could be 0 or 2, other blocks would always be 0
...
def rsnet18():
    ...
    """
    return RSNet(BasicBlock, [2, 2, 2, 2], num_classes=6)

def rsnet34():
    """ return a RSNet 34 object
    """
    return RSNet(BasicBlock, [3, 4, 6, 3], num_classes=6)
